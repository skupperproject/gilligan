...
valuesMatrix.prototype.setRowCol = function(
  r,
  c,
  ingress,
  egress,
...
valuesMatrix.prototype.addRow = function(
  chordName,
  ingress,
  egress,
  address,
...
valuesMatrixRow.prototype.addCol = function(messages, address) {
  this.cols.push(
    new valuesMatrixCol(messages, this, this.cols.length, address)
  );
};
valuesMatrixCol.prototype.addMessages = function(messages) {
  if (
    !(this.messages === MIN_CHORD_THRESHOLD && messages === MIN_CHORD_THRESHOLD)
  )
    this.messages += messages;
};
